...
add wave -noupdate /pipelined_fpu_tb/dut/is_zero_a
add wave -noupdate /pipelined_fpu_tb/dut/is_zero_b
add wave -noupdate /pipelined_fpu_tb/dut/is_zero
add wave -noupdate /pipelined_fpu_tb/dut/is_infinite_a
add wave -noupdate /pipelined_fpu_tb/dut/is_infinite_b
add wave -noupdate /pipelined_fpu_tb/dut/is_infinite
add wave -noupdate /pipelined_fpu_tb/dut/is_nan_a
add wave -noupdate /pipelined_fpu_tb/dut/is_nan_b
add wave -noupdate /pipelined_fpu_tb/dut/is_nan
add wave -noupdate /pipelined_fpu_tb/dut/is_nnan
add wave -noupdate /pipelined_fpu_tb/dut/is_exception
add wave -noupdate /pipelined_fpu_tb/dut/is_subnormal_a
add wave -noupdate /pipelined_fpu_tb/dut/is_subnormal_b
add wave -noupdate /pipelined_fpu_tb/dut/is_subnormal
add wave -noupdate /pipelined_fpu_tb/dut/operand_types
...
add wave -noupdate /pipelined_fpu_tb/dut/result_range
